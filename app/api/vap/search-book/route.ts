...
/* ---------------- Helper: Parse Vapi Tool Arguments ---------------- */
...
async function processBookSearch(bookId: unknown, query: unknown) {
  ...
  // Search segments using Appwrite
  ...
  // Use `text` field — matches your Appwrite segments collection
